...
/**
 * Sanitizes JSON-LD data to prevent XSS vulnerabilities when injected via dangerouslySetInnerHTML.
 * Ensures undefined inputs are handled to prevent runtime errors with .replace().
 */
