...
const extras = {
  en: {
    Reservation: {
      ...
      flexibleCancelText: 'If your plans change, our guest relations team is by your side for date changes and cancellations.',
  ...
  tr: {
    Reservation: {
      ...
      flexibleCancelText: 'Planlarınız değişirse misafir ilişkileri ekibimiz tarih değişikliği ve iptalde yanınızda.',
