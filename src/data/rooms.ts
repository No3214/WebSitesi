...
export const rooms: Room[] = [
  {
    ...
    description:
      "Kozbeyli'nin 1870-1891 tüccar mirasını en saf haliyle yansıtan bu oda, orijinal andezit taş duvarları ve Horasan harcı detaylarıyla doğal bir termal kütle etkisi sunar. 180 yıllık tarihi Dibek Kahvesi ritüelinin gerçekleştiği avluya sadece bir adım uzaklıkta olup, köyün beş asırlık yerleşim hafızasını pencerelerinden içeri taşır. İç bahçe manzarasıyla 'Slow Living' felsefesini tam merkezinde deneyimlemek isteyen misafirlerimiz için tasarlanmıştır.",
    capacity: "2 Yetişkin",
    size: "24 m²",
    view: "İç Bahçe",
    amenities: ["Bahçe Manzarası", "Klima", "LCD TV", "Wi-Fi", "Özel Banyo"],
    images: [
      "/images/odalar/standart-bahce-manzarali-oda/1.jpg",
      "/images/odalar/standart-bahce-manzarali-oda/2.jpg",
      "/images/odalar/standart-bahce-manzarali-oda/3.jpg",
      "/images/odalar/standart-bahce-manzarali-oda/4.jpg",
      "/images/odalar/detay/oda-detay-3.jpg",
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "28 metrekarelik geniş yerleşimiyle küçük gruplar için ideal bir 'miras sığınağı' olan Üç Kişilik Oda, yüksek tavanlı Osmanlı kentsel konut mimarisinin (L-Tipi Sofa) ferahlığını sunar. Oda, Kozbeyli'nin sismik dirençli andezit kaya tabanı üzerinde, kalın taş duvarların sağladığı doğal mikro-klima avantajıyla her zaman ideal bir serinliğe sahiptir. Pencerelerden giren Poyraz rüzgarları, köyün 180 metre rakımlı temiz havasını odanızın asaletine entegre eder.",
    capacity: "3 Yetişkin",
    size: "28 m²",
    view: "Köy ve Doğa",
    amenities: ["Çift + Tek Kişilik Yatak", "Klima", "LCD TV", "Wi-Fi", "Minibar"],
    images: [
      "/images/odalar/3-kisilik-oda/1.jpg",
      "/images/odalar/3-kisilik-oda/2.jpg",
      "/images/odalar/3-kisilik-oda/3.jpg",
      "/images/odalar/3-kisilik-oda/4.jpg",
  ...
  },
  {
    ...
    description:
      "Superior 2 Kişilik Oda, Kozbeyli Konağı'nın sunduğu en yüksek konfor standartlarını temsil eden 40 metrekarelik bir lüks süittir. Kesintisiz Ege Denizi manzarasına sahip olan bu oda, içerisinde bulunan özel tasarım küvetiyle bir spa deneyimi vaat eder. Teknik donanımında Bose ses sistemi, Nespresso kahve makinesi ve L'Occitane markalı premium buklet ürünleri yer almaktadır. Antika mobilyalarla döşenmiş olan iç mekan, 19. yüzyılın asaletini 21. yüzyıl teknolojileriyle başarıyla entegre eder. Özellikle balayı çiftleri ve özel yıl dönümü kutlamaları için tasarlanan bu oda, misafirlerine Kozbeyli Köyü'ndeki en prestijli konaklama deneyimini sunar. Yastık menüsü ve özel oda servisi seçenekleriyle her anı kişiselleştirilmiş bir hizmet sunulmaktadır.",
    capacity: "2 Yetişkin",
    size: "40 m²",
    view: "Panoramik Deniz",
    amenities: ["Küvet & Duş", "Deniz Manzarası", "Premium Buklet Seti", "Bose Ses Sistemi", "Nespresso Makinesi"],
    images: [
      "/images/odalar/superrior-oda-deniz-manzarali/1.jpg",
      "/images/odalar/superrior-oda-deniz-manzarali/2.jpg",
      "/images/odalar/superrior-oda-deniz-manzarali/3.jpg",
      "/images/odalar/superrior-oda-deniz-manzarali/4.jpg",
    ],
  },
  {
    slug: "superior-3-kisilik-oda",
    title: "Superior 3 Kişilik Oda",
    short: "42 metrekarelik, 3 kişi kapasiteli, küvetli ve deniz manzaralı oda.",
    description:
      "42 metrekarelik Superior 3 Kişilik Oda; üç yetişkine uygun yatak düzenini, küvetli banyoyu ve panoramik Ege Denizi manzarasını aynı konaklama biriminde buluşturur. Taş konağın özgün dokusunu koruyan oda, daha geniş yaşam alanı arayan çiftler, arkadaş grupları ve küçük aileler için tasarlanmıştır.",
    capacity: "3 Yetişkin",
    size: "42 m²",
    view: "Panoramik Deniz",
    amenities: ["Küvet & Duş", "3 Kişilik Yatak Düzeni", "Deniz Manzarası", "Premium Buklet Seti", "Nespresso Makinesi"],
    images: [
      "/images/odalar/superrior-3-kisilik-oda-deniz-manzarali/1.jpg",
      "/images/odalar/superrior-3-kisilik-oda-deniz-manzarali/2.jpg",
      "/images/odalar/superrior-3-kisilik-oda-deniz-manzarali/3.jpg",
      "/images/odalar/superrior-3-kisilik-oda-deniz-manzarali/4.jpg",
      "/images/odalar/superrior-3-kisilik-oda-deniz-manzarali/5.jpg",
      "/images/odalar/superrior-3-kisilik-oda-deniz-manzarali/6.jpg",
    ],
  },
];
