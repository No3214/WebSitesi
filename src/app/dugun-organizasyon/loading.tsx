export default function DugunOrganizasyonLoading() {
  return (
    <div style={{ minHeight: '100vh', paddingTop: '80px' }}>
      <div className="skeleton skeleton-header" />
      <div className="container" style={{ paddingTop: '40px' }}>
        <div className="skeleton skeleton-text" style={{ width: '350px', margin: '0 auto 16px' }} />
        <div className="skeleton skeleton-text" style={{ width: '550px', margin: '0 auto 48px' }} />
