        ...
        {copy.archives.map((item, i) => (
          ...
          >
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden transition-all duration-1000 border border-[rgba(61,74,59,0.14)]">
              <Image src={item.image} alt={item.title} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover scale-110 group-hover:scale-100 transition-transform duration-[2000ms]" />
