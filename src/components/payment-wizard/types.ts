...
export const WIZARD_COPY = {
  tr: {
    ...
    sensory: {
      ...
      back: "Geri",
      next: "Talep Bilgileri",
    },
    payment: {
      title: "Misafir & İletişim Bilgileri",
      ...
      sound: "Ses:",
      light: "Işık:",
      roomTotal: "Güncel Oda Tutarı:",
      due: "Teyit Sonrası Netleşecek Tutar:",
    ...
    success: {
      ...
      bodySuffix: "Rezervasyon talebiniz ve atmosfer kişiselleştirme seçimleriniz sisteme kaydedildi. Ödeme bilgisi alınmadı — ekibimiz resepsiyon saatleri içinde teyit için sizinle iletişime geçecek; tahsilat, Garanti BBVA Sanal POS güvenli ödeme adımıyla tamamlanacak.",
      bookingNo: "Rezervasyon Numarası:",
      roomType: "Oda Tipi:",
      dates: "Giriş / Çıkış:",
      preferences: "Atmosfer Tercihleri:",
      collected: "Güncel Tutar:",
    ...
    errors: {
      ...
      paymentFailed: "Rezervasyon talebi gönderilemedi.",
      gatewayFailed: "Rezervasyon talebi şu anda iletilemedi. Lütfen tekrar deneyiniz.",
    },
    whatsapp: {
      hello: "Merhaba Kozbeyli Konağı, web sitenizden ön-rezervasyon talebi oluşturdum.",
      ...
      sound: "Ses Atmosferi",
      light: "Işık Tercihi",
      total: "Teyit Edilecek Tutar",
      totalPending: "HMS / ekip teyidi",
      guestName: "Misafir",
  ...
  en: {
    ...
    payment: {
      title: "Guest and Contact Details",
      ...
      sound: "Sound:",
      light: "Light:",
      roomTotal: "Current Room Amount:",
      due: "Amount Confirmed After Review:",
    ...
    success: {
      ...
      bodySuffix: "Your reservation request and atmosphere preferences were recorded. No payment details were collected. Our team will contact you during reception hours for confirmation; payment is completed through Garanti BBVA's secure virtual POS step.",
    ...
    errors: {
      ...
      paymentFailed: "The reservation request could not be sent.",
      gatewayFailed: "The reservation request could not be sent right now. Please try again.",
    },
    whatsapp: {
      ...
      total: "Total Amount",
      totalPending: "HMS / team confirmation",
      guestName: "Guest",
