...
export const WIZARD_COPY = {
  tr: {
    ...
    payment: {
      ...
      sound: "Ses:",
      light: "Işık:",
      roomTotal: "Tahmini Oda Tutarı:",
      due: "Teyit Sonrası Ödenecek Tutar:",
    ...
    success: {
      ...
      collected: "Teyit Edilecek Tutar:",
  ...
  en: {
    ...
    payment: {
      ...
      sound: "Sound:",
      light: "Light:",
      roomTotal: "Estimated Room Amount:",
      due: "Amount Due After Confirmation:",
    ...
    success: {
      ...
      collected: "Amount to Be Confirmed:",
