...
## Stil DNA Uygulaması (Mathematical Precision)

Ajan, `style_dna.md` dosyasındaki şu kuralları mesaj başına uygular:
- **Cümle Ritmi**: Ortalama 18 kelime. Duygusal sıfatlar yerine teknik veriler (Örn: "Güzel oda" yerine "Kozbeyli taşının termal konforunu sunan tescilli oda").
- **Noktalama**: Kelime başına yüksek virgül ve iki nokta rasyosu.
- **Kelime Seçimi**: "En iyi" yerine "Özgün", "Güzel" yerine "Rafine".
