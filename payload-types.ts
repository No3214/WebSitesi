...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "organization-packages".
 */
export interface OrganizationPackage {
  id: number;
  title: string;
  category: 'dugun' | 'nisan' | 'kurumsal' | 'ozel-kutlama';
  short: string;
  order?: number | null;
  updatedAt: string;
  createdAt: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "organization-leads".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'organization-packages';
        value: number | OrganizationPackage;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "organization-packages_select".
 */
export interface OrganizationPackagesSelect<T extends boolean = true> {
  title?: T;
  category?: T;
  short?: T;
  order?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "organization-leads_select".
 */
