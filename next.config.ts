...
// eval-based source maps; allow 'unsafe-eval' only outside production so local
// previews hydrate while production CSP remains strict.
...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/en-US/gallery", destination: "/en/gallery", permanent: true },
      { source: "/en-US/contact", destination: "/en/contact", permanent: true },
