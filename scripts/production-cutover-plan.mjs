...
const gateActionCatalog = {
  canonical_domain: {
    ...
    actions: [
      ...
      "Correct the authoritative Isimtescil/Vercel domain configuration so canonical and brand domains resolve to the Vercel production deployment, not the old landing host.",
