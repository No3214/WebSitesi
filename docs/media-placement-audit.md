...
- Use existing site videos only where the video content matches the section:
  - Homepage: `/videos/hero-property.mp4` derived from the exterior opening of `/videos/hero.mp4`
...
| --- | --- | --- | --- |
| Homepage hero poster | `/images/hero-video-poster.jpg` | Frame from `/videos/hero-property.mp4` | Keeps poster and intro video consistent. |
| Homepage hero video | `/videos/hero-property.mp4` | Exterior-only derivative of existing `/videos/hero.mp4` | Keeps the first viewport focused on the actual stone hotel exterior. |
...
| `public/videos/hero.mp4` | `D8293CD9E7703E808D87C6F0ED1C761DD13657BD5C36C3916FF215981739F697` |
